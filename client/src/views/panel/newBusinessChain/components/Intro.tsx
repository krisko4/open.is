import { Button, Card, CardContent, Fade, Grid, Slide, Typography } from '@mui/material';
import React, { FC } from 'react';
import { NewPlaceStepper } from 'views/panel/newPlace/components/NewPlaceStepper';
