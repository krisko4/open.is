    ...
    <StyledContainer container alignItems="center">
      <Grid container>
        <Grid
          ...
          lg={5}
          style={{ textAlign: 'center', marginLeft: 150, marginBottom: 150 }}
        >
          ...
          <Grid item lg={10} style={{ marginTop: 20 }}>
            <Slide in={true} timeout={2000}>
              <Typography style={{ color: 'white' }} variant="h6">
                We strongly believe that by encouraging our users to actively interact and take care of social aspects
                of their businesses, we can create a leading global platform for finding and managing places.
              </Typography>
            </Slide>
          </Grid>
        </Grid>
