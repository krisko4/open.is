      ...
      <Grid container>
        ...
        <Grid container item sx={{ mt: '20px' }}>
          <Grid item lg={3} sx={{ ml: '20px', textAlign: 'center' }}>
            <CardMedia
              style={{ height: 200, backgroundSize: 'contain', marginTop: 10, borderRadius: 20 }}
              image={place.logo as string}
            />
            <Rating style={{ marginTop: 20 }} name="simple-controlled" value={place.averageNote?.average} readOnly />
          </Grid>
