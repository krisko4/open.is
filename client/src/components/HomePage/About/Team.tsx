import {
  Avatar, CardMedia, Fade, Slide, Grid, Typography,
} from '@mui/material';
...
export const Team: FC = () => {
  ...
  const handleScroll = () => {
    ...
    // setVisible7(window.scrollY > 3000);
        ...
        <Fade in={isVisible2} timeout={2000}>
          ...
          <Grid item container lg={5} justifyContent="center" alignItems="center" direction="column">
            ...
            <Typography variant="h6" style={{ textAlign: 'center', marginTop: 20 }}>
              ...
              I am a development manager, which makes me responsible for all the stuff connected with proper development of our services.
      ...
      <Grid container justifyContent="space-evenly" style={{ paddingTop: 20 }}>
        <Fade in={isVisible3} timeout={2000}>
          <Grid item container lg={5} justifyContent="center" alignItems="center" direction="column">
            ...
            <Typography variant="h6" style={{ textAlign: 'center', marginTop: 20 }}>
              Hi, my name is George Suchodolsky and I am a Promotion manager.
