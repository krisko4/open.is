...
const useStyles = makeStyles<Theme, StyleProps>(theme => ({
    ...
    banner: {
        ...
        overflow: 'hidden',
        '&&::before': {
            backgroundImage: props => `linear-gradient(rgba(0, 0, 0, ${props.gradient1}),rgba(0, 0, 0, ${props.gradient2})), url(${process.env.REACT_APP_BASE_URL}/images/background.jpg)`,
...
export const Banner: FC = () => {
    ...
    const [gradient1, setGradient1] = useState(0.1)
    const [gradient2, setGradient2] = useState(0.2)
    ...
    const handleScroll = () => {
        ...
        //if(window.scrollY > 50) setGradient(0.5)
    }
        ...
        <Grid container className={classes.banner} alignItems="center">
            ...
            <Grid item container lg={8} justify="center">
                <Grid item xs={7} style={{ textAlign: 'center', marginBottom: 40 }}>
                    <Collapse in={window.scrollY < 50} timeout={1500}>
                    ...
                    <Fade in={window.scrollY < 50} timeout={2000}>
