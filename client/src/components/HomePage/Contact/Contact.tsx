                            ...
                            <CardContent>
                                <Grid container justifyContent="space-between">
                                    ...
                                    <Grid container alignItems="center" justifyContent="center" item xs={6}>
                                        ...
                                        <IconButton size="large"><SocialIcon target="_blank" rel="noopener noreferrer" style={{ width: 35, height: 35, display: 'table-cell' }} url="http://twitter.com" /></IconButton>
                                        <IconButton size="large"><SocialIcon target="_blank" rel="noopener noreferrer" style={{ width: 35, height: 35, display: 'table-cell' }} url="http://gmail.com" /></IconButton>
                                    </Grid>
                                </Grid>
                                <Grid container justifyContent="center">
