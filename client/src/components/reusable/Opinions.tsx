...
export const Opinions: FC<Props> = ({ classes, currentPlace, setCurrentPlace, opinions, setOpinions, opinionCount, setOpinionCount }) => {
    ...
    return (
        <Grid container justify="center">
            <Grid container item lg={11} direction="column" style={{ marginTop: 20 }}>
                {opinions.length > 0 ?
                    <div>
                        ...
                        </Grid>
                        {
                            opinions.map((opinion, index) =>
                                <Grid item key={index} style={{ marginBottom: 20 }}>
                    ...
                    : <Grid container direction="column" justify="center" style={{ height: 400 }} alignItems="center">
