...
import { Button, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, Fade, IconButton, InputAdornment, Rating, TextField, Typography } from '@mui/material';
                    ...
                    <Grid container item xs={11} direction="column" style={{ marginTop: 20, marginBottom: 20 }}>
                        ...
                        {userData.isLoggedIn &&
                            ...
                            >
                                ...
                                <DialogActions>
                                    <LoadingButton loading={isLoading} disabled={!noteValue || isLoading} onClick={submitOpinion} variant="contained" color="primary">Submit</LoadingButton>
                                </DialogActions>
                            </Dialog>
                        }
                    </Grid >
