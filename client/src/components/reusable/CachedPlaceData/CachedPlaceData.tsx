                    ...
                    <Grid container item sx={{ mt: '20px' }}>
                        ...
                        <Grid item container direction="column" lg={8} sx={{ ml: '30px' }}>
                            ...
                            <Typography variant="h6">
                                {place.subtitle || 'This is a short subtitle of your business'}
                            </Typography>
                                ...
                                <CardContent>
                                    <div style={{ display: 'inline-block', overflowWrap: 'break-word' }}>
                                        <Typography variant="body1" >
                                            {place.description || 'This is a brief description of your business. In this section you can make your visitors interested in your company.'}
                                        </Typography>
                                    </div>
                                </CardContent>
                            </Card>
